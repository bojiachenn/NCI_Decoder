...
# Table 117: NFCEE_DISCOVER_NTF NFCEE Status (NOT the same field as tbl_nfcee_status / Table 132 below)
...
# Table 132: NFCEE_STATUS_NTF NFCEE Status (NOT the same field as tbl_nfcee_disc_status / Table 117 above)
tbl_nfcee_status={
