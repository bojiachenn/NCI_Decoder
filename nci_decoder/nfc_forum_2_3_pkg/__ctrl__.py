from nfc_forum_2_3_pkg import NCI_Core
from nfc_forum_2_3_pkg import RF_Management
from nfc_forum_2_3_pkg import NFCEE_Management
...
tbl_nci_ctrl = {
	...
	"RF Management": {
		...
		'12':  {"CMD": RF_Management.RF_REMOVAL_DETECTION_CMD,			"RSP": RF_Management.RF_REMOVAL_DETECTION_RSP,        	"NTF": RF_Management.RF_REMOVAL_DETECTION_NTF},
		'13':  {																				                                "NTF": RF_Management.RF_WLC_STATUS_NTF},
		'14':  {"CMD": RF_Management.GET_WLCP_INFO_PARAM_CMD,			"RSP": RF_Management.GET_WLCP_INFO_PARAM_RSP,        	},# "NTF": RF_Management.GET_WLCP_INFO_PARAM_NTF
		'15':  {"CMD": RF_Management.WPT_START_CMD,						"RSP": RF_Management.WPT_START_RSP,        				"NTF": RF_Management.WPT_START_NTF},
		# 12 ~ 63 RFU
	},
	"NFCEE Management": {
