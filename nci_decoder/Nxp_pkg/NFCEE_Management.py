...
def NFCEE_DISCOVER_CMD(raw):
	...
	p_payload = Origin.NFCEE_DISCOVER_CMD(raw, "nxp")
	return p_payload
...
def NFCEE_DISCOVER_RSP(raw):
	...
	p_payload = Origin.NFCEE_DISCOVER_RSP(raw, "nxp")
	return p_payload
...
def NFCEE_DISCOVER_NTF(raw):
	...
	p_payload = Origin.NFCEE_DISCOVER_NTF(raw, "nxp")
	return p_payload
...
def NFCEE_MODE_SET_CMD(raw):
	...
	p_payload = Origin.NFCEE_MODE_SET_CMD(raw, "nxp")
	return p_payload
...
def NFCEE_MODE_SET_RSP(raw):
	...
	p_payload = Origin.NFCEE_MODE_SET_RSP(raw, "nxp")
	return p_payload
...
def NFCEE_MODE_SET_NTF(raw):
	...
	p_payload = Origin.NFCEE_MODE_SET_NTF(raw, "nxp")
	return p_payload
...
def NFCEE_STATUS_NTF(raw):
	...
	p_payload = Origin.NFCEE_STATUS_NTF(raw, "nxp")
	return p_payload
...
def NFCEE_POWER_AND_LINK_CNTRL_CMD(raw):
	...
	p_payload = Origin.NFCEE_POWER_AND_LINK_CNTRL_CMD(raw, "nxp")
	return p_payload
...
def NFCEE_POWER_AND_LINK_CNTRL_RSP(raw):
	...
	p_payload = Origin.NFCEE_POWER_AND_LINK_CNTRL_RSP(raw, "nxp")
	return p_payload